...
const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm, images }) => {
  ...
  const handleReplacementFlowerChange = ({ value }) => {
    setReplacementFlower(value);
  };

  const handleConfirm = () => {
    onConfirm(replacementFlower);
    onClose();
  };

  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full flex items-center flex-col">
