      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-4 w-full">
          {images.map((img) => (
            <div
              key={img.id}
              className={`bg-white rounded-2xl shadow-md w-[194px] flex flex-col items-center p-0 cursor-pointer ${
            ...
            >
              <div className="flex justify-center relative w-full">
                <img
                  src={img.image}
                  alt={img.name}
                  className={`h-[160px] w-[160px] object-contain rounded-[10px] bg-[#e3e6d3] mt-[13px] ${
